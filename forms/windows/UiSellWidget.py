...
class Ui_SellWidget(object):
    def setupUi(self, SellWidget):
        ...
        self.chosen_seats_lb_2 = QtWidgets.QLabel(SellWidget)
        self.chosen_seats_lb_2.setGeometry(QtCore.QRect(30, 170, 141, 21))
        self.chosen_seats_lb_2.setText("")
        self.chosen_seats_lb_2.setObjectName("chosen_seats_lb_2")
        self.seats_table = QtWidgets.QTableWidget(SellWidget)
        self.seats_table.setGeometry(QtCore.QRect(170, 50, 511, 451))
        self.seats_table.setObjectName("seats_table")
        self.seats_table.setColumnCount(0)
